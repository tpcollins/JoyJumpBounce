...
//             <button type="submit" className="fl-btn st-6" disabled={loading}>
//               <span className="inner">{loading ? 'Sending...' : 'Send message'}</span>
//             </button>
//           </div>
//           {emailSent && <p>Thank you! Your message has been sent.</p>}
//         </div>
//       </form>
//     </div>
//   );

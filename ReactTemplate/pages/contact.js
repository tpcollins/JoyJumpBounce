...
import ContactForm from "../src/R Components/contactform";
...
const Contact = () => {
  return (
    <>
                ...
                <div className="col-12"> 
                  <div className="title-heading st-2">
                    ...
                    <h2 className="title clr-pri-2">
                      View our Information or Send us a Message Below!
                    </h2>
                  </div>
                </div>
              </div>
                  ...
                  <div className="wrap-contact">
                    ...
                    <div className="fx Email">
                      ...
                      <div className="content">
                        <p>Email Address</p>
                        <h4>JoyJumpInflatables@gmail.com</h4>
                      </div>
                    </div>
      ...
      {/* This is the map. Need to ask Johnny and Noah if they want this pointed anywhere */}
      {/* <section>
      ...
      {/* This is the original contact form. Leaving this in for once functionality starts incase section header -
      - contains some sort of functionality (tf-section tf-message)
      */}
